function LoadFonts()
    if Settings.FontSelected=="Stylized" then
        SmallBodyFont=love.graphics.newFont("Fonts/Exo2.ttf", scaling(20,1080,Settings.YRes,true))
        SmallBodyFontBold=love.graphics.newFont("Fonts/Exo2-Bold.ttf", scaling(20,1080,Settings.YRes,true))
        BodyFont=love.graphics.newFont("Fonts/Exo2.ttf", scaling(24,1080,Settings.YRes,true))
        BodyFontBold=love.graphics.newFont("Fonts/Exo2-Bold.ttf", scaling(24,1080,Settings.YRes,true))
        LargeBodyFont=love.graphics.newFont("Fonts/Exo2.ttf", scaling(28,1080,Settings.YRes,true))
        LargeBodyFontBold=love.graphics.newFont("Fonts/Exo2-Bold.ttf", scaling(28,1080,Settings.YRes,true))
        SmallHeaderBold=love.graphics.newFont("Fonts/Exo2-Bold.ttf", scaling(32,1080,Settings.YRes,true))
        LargeHeader1=love.graphics.newFont("Fonts/Exo2-Black.ttf", scaling(45,1080,Settings.YRes,true))
        MediumHeaderBold=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(34,1080,Settings.YRes,true))
        LargerHeader2=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(60,1080,Settings.YRes,true))
    end
    if Settings.FontSelected=="Exo2" then
        ...
        LargerHeader2=love.graphics.newFont("Fonts/Exo2-Black.ttf", scaling(60,1080,Settings.YRes,true))
    end
    if Settings.FontSelected=="AtkinsonHyperlegible" then
        SmallBodyFont=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Regular.ttf", scaling(20,1080,Settings.YRes,true))
        SmallBodyFontBold=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(20,1080,Settings.YRes,true))
        BodyFont=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Regular.ttf", scaling(24,1080,Settings.YRes,true))
        BodyFontBold=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(24,1080,Settings.YRes,true))
        LargeBodyFont=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Regular.ttf", scaling(28,1080,Settings.YRes,true))
        LargeBodyFontBold=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(28,1080,Settings.YRes,true))
        SmallHeaderBold=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(32,1080,Settings.YRes,true))
        LargeHeader1=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(45,1080,Settings.YRes,true))
        MediumHeaderBold=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(34,1080,Settings.YRes,true))
        LargerHeader2=love.graphics.newFont("Fonts/AtkinsonHyperlegible-Bold.ttf", scaling(60,1080,Settings.YRes,true))
    end
    if Settings.FontSelected=="IBMPlex" then
        SmallBodyFont=love.graphics.newFont("Fonts/IBMPlexMono-Regular.ttf", scaling(20,1080,Settings.YRes,true))
        SmallBodyFontBold=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(20,1080,Settings.YRes,true))
        BodyFont=love.graphics.newFont("Fonts/IBMPlexMono-Regular.ttf", scaling(24,1080,Settings.YRes,true))
        BodyFontBold=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(24,1080,Settings.YRes,true))
        LargeBodyFont=love.graphics.newFont("Fonts/IBMPlexMono-Regular.ttf", scaling(28,1080,Settings.YRes,true))
        LargeBodyFontBold=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(28,1080,Settings.YRes,true))
        SmallHeaderBold=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(32,1080,Settings.YRes,true))
        LargeHeader1=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(45,1080,Settings.YRes,true))
        MediumHeaderBold=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(34,1080,Settings.YRes,true))
        LargerHeader2=love.graphics.newFont("Fonts/IBMPlexMono-Bold.ttf", scaling(60,1080,Settings.YRes,true))
    end
